...
.. image:: ../../res/finite_volume_discretization/tsunami_animation_shock_4_2.gif
   :align: center

- Shock Shock with parameters :math:`(h = 4, m = 10)`:

.. image:: ../../res/finite_volume_discretization/tsunami_animation_shock_4_10.gif
   :align: center
...
.. image:: ../../res/finite_volume_discretization/tsunami_animation_rare_4_2.gif
   :align: center

- Rare Rare with parameters :math:`(h = 4, m = 10)`:

.. image:: ../../res/finite_volume_discretization/tsunami_animation_rare_4_10.gif
   :align: center
...
.. image:: ../../res/finite_volume_discretization/tsunami_animation_shock_10_10.gif
   :align: center

- Rare Rare with parameters :math:`(h = 10, m = 10)`:

.. image:: ../../res/finite_volume_discretization/tsunami_animation_rare_10_10.gif
   :align: center
...
.. image:: ../../res/finite_volume_discretization/tsunami_animation_10_5.gif
   :align: center

- DamBreak with parameters :math:`(h_L = 16, m_L = 0, h_R = 3, m_R = 0)`:

.. image:: ../../res/finite_volume_discretization/tsunami_animation_16_3.gif
   :align: center
...
.. image:: ../../res/finite_volume_discretization/tsunami_animation_15_0_5_0.gif
   :align: center

- DamBreak with parameters :math:`(h_L = 15, m_L = 0, h_R = 5, m_R = -10)`, :math:`u_r` is negative (wave is slower and taller):

.. image:: ../../res/finite_volume_discretization/tsunami_animation_15_0_5_-10.gif
   :align: center

- DamBreak with parameters :math:`(h_L = 15, m_L = 0, h_R = 5, m_R = 10)`, :math:`u_r` is positive (wave is faster and less tall):

.. image:: ../../res/finite_volume_discretization/tsunami_animation_15_0_5_10.gif
   :align: center
...
.. image:: ../../res/finite_volume_discretization/tsunami_animation_15_0_5_-3.gif
   :align: center
...
.. image:: ../../res/finite_volume_discretization/tsunami_animation_evacuation.gif
   :align: center
